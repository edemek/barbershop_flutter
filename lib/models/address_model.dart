...
import '../models/parent/model.dart';
...
class Address extends Model {
  ...
  Address.fromJson(Map<String, dynamic>? json) {
    ...
    latitude = doubleFromJson(json, 'latitude', decimal: 10, defaultValue: 0);
    longitude = doubleFromJson(json, 'longitude', decimal: 10, defaultValue: 0);
    isDefault = boolFromJson(json, 'default');
    userId = stringFromJson(json, 'user_id');
  }

  LatLng getLatLng() => isUnknown()
      ? LatLng(38.806103, 52.4964453)
