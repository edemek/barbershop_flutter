...
class BookingView extends GetView<BookingController> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      bottomNavigationBar: (controller.booking.value.atSalon)
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      Flexible(
                        child:
                            BookingAddressChipWidget(booking: _booking.value),
                      ),
                    ],
                  ),
                ],
                  ...
                  children: [
                    ...
                    Text(
                        DateFormat('dd', Get.locale.toString())
                            .format(_booking.value.bookingAt ?? DateTime.now()),
                        maxLines: 1,
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(_booking.salon?.phoneNumber ?? '',
                    style: Get.textTheme.bodySmall),
              ],
            ),
          ),
